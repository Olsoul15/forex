...
# Create a router for the API menu endpoint at the root level
api_menu_router = APIRouter(tags=["documentation"])

@api_menu_router.get("/api-menu", summary="Get a list of all available API endpoints")
async def get_api_menu(request: Request) -> Dict[str, Any]:
    """
